...
int main(int argc, char* argv[]) {
  ...
  //buildFromDB, lumiCalc2, useHists, std::string file
  //sim.setupLumi(false, true, true, e->lumiFile); //original
  sim.setupLumi(false, true, false, e->lumiFile); //useHists is false
