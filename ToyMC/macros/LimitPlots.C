...
void LimitPlots::readMchampData(std::string filename) {
...
void LimitPlots::calculateCrossSections(unsigned gluinoIndex, unsigned stopIndex, unsigned mchampIndex, unsigned toyIndex, unsigned tpIndex) {
...
TGraphAsymmErrors* LimitPlots::getExpLimitMchamp2Sig() {
	return new TGraphAsymmErrors(xsProdExpLimitToyMchamp.size(),
								&toyLifetime[0],
								&xsProdExpLimitToyMchamp[0],
								0,
...
TGraphAsymmErrors* LimitPlots::getExpMassLimitMchamp2Sig() {
	return new TGraphAsymmErrors(xsProdExpMassMchamp.size(),
				     &massMchamp[0],
				     &xsProdExpMassMchamp[0],
				     0,
...
TGraph* LimitPlots::getMchampTheory() {
