...
# with command line options: skims -s SKIM:ZMu --data --dasquery=file dataset=/SingleMu/CMSSW_7_1_0_pre7-PRE_R_71_V2_RelVal_wMu2011A-v1/RECO -n -1 --no_exec --conditions PRE_R_72_V11A --python_filename=ZMu_SKIM.py --processName=SkimZMu
import FWCore.ParameterSet.Config as cms

process = cms.Process('SkimZMu')
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/mnt/hadoop/store/user/jalimena/SingleMu/Reco_SingleMu_Run2012A_723patch1/150123_021512/0000/reco_1.root'
                                      )
)
...
process.dimuons.cut = cms.string('mass > 70 && mass < 110')
...
# Schedule definition
process.schedule = cms.Schedule(process.ZMuSkimPath,process.SKIMStreamZMuOutPath)
