...
from StoppedHSCPMuon.Ntuples.stoppedHSCPMuonTree_Master_ControlTriggers_cfg import *
...
from StoppedHSCPMuon.Ntuples.StoppedHSCPMuon_ControlTrigger2012_cff import *
