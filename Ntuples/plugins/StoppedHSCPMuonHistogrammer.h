#ifndef StoppedHSCPMuonHistogrammer_h
#define StoppedHSCPMuonHistogrammer_h
...
class StoppedHSCPMuonHistogrammer : public edm::EDAnalyzer {

 public:

  explicit StoppedHSCPMuonHistogrammer(const edm::ParameterSet& iPSet);
  ~StoppedHSCPMuonHistogrammer();
