...
#include "StoppedHSCPMuon/Ntuples/plugins/StoppedHSCPMuonHistogrammer.h"

StoppedHSCPMuonHistogrammer::StoppedHSCPMuonHistogrammer(const edm::ParameterSet& iPSet)
{

}


StoppedHSCPMuonHistogrammer::~StoppedHSCPMuonHistogrammer() {
...
void StoppedHSCPMuonHistogrammer::beginJob() {

}


void StoppedHSCPMuonHistogrammer::beginRun(const edm::Run& iRun, const edm::EventSetup& iSetup) {
...
void StoppedHSCPMuonHistogrammer::beginLuminosityBlock(const edm::LuminosityBlock& iBlock, const edm::EventSetup& iSetup) {
...
void StoppedHSCPMuonHistogrammer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void StoppedHSCPMuonHistogrammer::endJob() {
...
void StoppedHSCPMuonHistogrammer::bookPerRunHistograms(unsigned long run) {
...
void StoppedHSCPMuonHistogrammer::bookPerFillHistograms(unsigned long fill) {
...
DEFINE_FWK_MODULE(StoppedHSCPMuonHistogrammer);
