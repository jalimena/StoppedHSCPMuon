...
StoppedHSCPMuonEvent::StoppedHSCPMuonEvent() :
  ...
  mu_StandAloneUpdatedAtVtx_N(0),
  muStandAloneUpdatedAtVtxCharge(0),
  muStandAloneUpdatedAtVtxPx(0),
  muStandAloneUpdatedAtVtxPy(0),
  muStandAloneUpdatedAtVtxPz(0),
  muStandAloneUpdatedAtVtxPt(0),
  muStandAloneUpdatedAtVtxP(0),
  muStandAloneUpdatedAtVtxEta(0),
  muStandAloneUpdatedAtVtxPhi(0),
  muStandAloneUpdatedAtVtxHcalEta(0),
  muStandAloneUpdatedAtVtxHcalPhi(0),
  muStandAloneTrackUpdatedAtVtxChi2(0),
  muStandAloneTrackUpdatedAtVtxNdof(0),
  muStandAloneTrackUpdatedAtVtxNormalizedChi2(0),
  muStandAloneTrackUpdatedAtVtxVx(0),
  muStandAloneTrackUpdatedAtVtxVy(0),
  muStandAloneTrackUpdatedAtVtxVz(0),
  muStandAloneTrackUpdatedAtVtxDxy(0),
  muStandAloneTrackUpdatedAtVtxDz(0),
  muStandAloneTrackUpdatedAtVtxNHits(0),
  muStandAloneTrackUpdatedAtVtxNLost(0),
  muStandAloneTrackUpdatedAtVtxNStationsWithAnyHits(0),
  muStandAloneTrackUpdatedAtVtxNCscChambersWithAnyHits(0),
  muStandAloneTrackUpdatedAtVtxNDtChambersWithAnyHits(0),
  muStandAloneTrackUpdatedAtVtxNRpcChambersWithAnyHits(0),
  muStandAloneTrackUpdatedAtVtxInnermostStationWithAnyHits(0),
  muStandAloneTrackUpdatedAtVtxOutermostStationWithAnyHits(0),
  muStandAloneTrackUpdatedAtVtxNValidMuonHits(0),
  muStandAloneTrackUpdatedAtVtxNValidCscHits(0),
  muStandAloneTrackUpdatedAtVtxNValidDtHits(0),
  muStandAloneTrackUpdatedAtVtxNValidRpcHits(0),
  muStandAloneTrackUpdatedAtVtxNStationsWithValidHits(0),
  muStandAloneTrackUpdatedAtVtxNCscChambersWithValidHits(0),
  muStandAloneTrackUpdatedAtVtxNDtChambersWithValidHits(0),
  muStandAloneTrackUpdatedAtVtxNRpcChambersWithValidHits(0),
  muStandAloneTrackUpdatedAtVtxInnermostStationWithValidHits(0),
  muStandAloneTrackUpdatedAtVtxOutermostStationWithValidHits(0),
  muStandAloneTrackUpdatedAtVtxQuality(0),
  muStandAloneTrackUpdatedAtVtxInnerPx(0),
  muStandAloneTrackUpdatedAtVtxInnerPy(0),
  muStandAloneTrackUpdatedAtVtxInnerPz(0),
  muStandAloneTrackUpdatedAtVtxInnerOk(0),
  muStandAloneTrackUpdatedAtVtxInnerX(0),
  muStandAloneTrackUpdatedAtVtxInnerY(0),
  muStandAloneTrackUpdatedAtVtxInnerZ(0),
  ...
  muStandAloneTrackUpdatedAtVtxDtTofInverseBetaErr(0),
  muStandAloneTrackUpdatedAtVtxDtTofFreeInverseBeta(0),
  muStandAloneTrackUpdatedAtVtxDtTofFreeInverseBetaErr(0),
  muStandAloneTrackUpdatedAtVtxDtTofTimeAtIpInOut(0),
  ...
  muStandAloneTrackUpdatedAtVtxShowerSize_station3(0), 
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station0(0), 
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station1(0), 
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station2(0), 
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station3(0), 
  muStandAloneTrackUpdatedAtVtxShowerNHits_station0(0), 
  muStandAloneTrackUpdatedAtVtxShowerNHits_station1(0), 
  muStandAloneTrackUpdatedAtVtxShowerNHits_station2(0), 
  muStandAloneTrackUpdatedAtVtxShowerNHits_station3(0), 
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station0(0), 
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station1(0), 
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station2(0), 
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station3(0), 
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station0(0), 
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station1(0), 
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station2(0), 
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station3(0), 
  muStandAloneTrackUpdatedAtVtxCscSegEndcap(0),
  muStandAloneTrackUpdatedAtVtxCscSegRing(0),
  muStandAloneTrackUpdatedAtVtxCscSegStation(0),
  muStandAloneTrackUpdatedAtVtxCscSegChamber(0),
  muStandAloneTrackUpdatedAtVtxCscSegNHits(0),
  muStandAloneTrackUpdatedAtVtxCscSegPhi(0),
  muStandAloneTrackUpdatedAtVtxCscSegZ(0),
  muStandAloneTrackUpdatedAtVtxCscSegR(0),
  muStandAloneTrackUpdatedAtVtxCscSegDirPhi(0),
  muStandAloneTrackUpdatedAtVtxCscSegDirTheta(0),
  muStandAloneTrackUpdatedAtVtxCscSegTime(0),
  muStandAloneTrackUpdatedAtVtxRpcHitZ(0),
  muStandAloneTrackUpdatedAtVtxRpcHitRho(0),
  muStandAloneTrackUpdatedAtVtxRpcHitPhi(0),
  muStandAloneTrackUpdatedAtVtxRpcHitRegion(0),
  muStandAloneTrackUpdatedAtVtxRpcHitBx(0),
...
void StoppedHSCPMuonEvent::addStandAloneMuonUpdatedAtVtx(Track track) { 
  muStandAloneUpdatedAtVtxCharge.push_back(track.charge);
  muStandAloneUpdatedAtVtxPx.push_back(track.px);
  muStandAloneUpdatedAtVtxPy.push_back(track.py);
  muStandAloneUpdatedAtVtxPz.push_back(track.pz);
  muStandAloneUpdatedAtVtxPt.push_back(track.pt);
  muStandAloneUpdatedAtVtxP.push_back(track.p);
  muStandAloneUpdatedAtVtxEta.push_back(track.eta);
  muStandAloneUpdatedAtVtxPhi.push_back(track.phi);
  muStandAloneUpdatedAtVtxHcalEta.push_back(track.hcalEta);
  muStandAloneUpdatedAtVtxHcalPhi.push_back(track.hcalPhi);
  muStandAloneTrackUpdatedAtVtxChi2.push_back(track.chi2);
  muStandAloneTrackUpdatedAtVtxNdof.push_back(track.ndof);
  muStandAloneTrackUpdatedAtVtxNormalizedChi2.push_back(track.normalizedChi2);
  muStandAloneTrackUpdatedAtVtxVx.push_back(track.vx);
  muStandAloneTrackUpdatedAtVtxVy.push_back(track.vy);
  muStandAloneTrackUpdatedAtVtxVz.push_back(track.vz);
  muStandAloneTrackUpdatedAtVtxDxy.push_back(track.dxy);
  muStandAloneTrackUpdatedAtVtxDz.push_back(track.dz);
  muStandAloneTrackUpdatedAtVtxNHits.push_back(track.nHits);
  muStandAloneTrackUpdatedAtVtxNLost.push_back(track.nLost);
  muStandAloneTrackUpdatedAtVtxNStationsWithAnyHits.push_back(track.nStationsWithAnyHits);
  muStandAloneTrackUpdatedAtVtxNCscChambersWithAnyHits.push_back(track.nCscChambersWithAnyHits);
  muStandAloneTrackUpdatedAtVtxNDtChambersWithAnyHits.push_back(track.nDtChambersWithAnyHits);
  muStandAloneTrackUpdatedAtVtxNRpcChambersWithAnyHits.push_back(track.nRpcChambersWithAnyHits);
  muStandAloneTrackUpdatedAtVtxInnermostStationWithAnyHits.push_back(track.innermostStationWithAnyHits);
  muStandAloneTrackUpdatedAtVtxOutermostStationWithAnyHits.push_back(track.outermostStationWithAnyHits);
  muStandAloneTrackUpdatedAtVtxNValidMuonHits.push_back(track.nValidMuonHits);
  muStandAloneTrackUpdatedAtVtxNValidCscHits.push_back(track.nValidCscHits);
  muStandAloneTrackUpdatedAtVtxNValidDtHits.push_back(track.nValidDtHits);
  muStandAloneTrackUpdatedAtVtxNValidRpcHits.push_back(track.nValidRpcHits);
  muStandAloneTrackUpdatedAtVtxNStationsWithValidHits.push_back(track.nStationsWithValidHits);
  muStandAloneTrackUpdatedAtVtxNCscChambersWithValidHits.push_back(track.nCscChambersWithValidHits);
  muStandAloneTrackUpdatedAtVtxNDtChambersWithValidHits.push_back(track.nDtChambersWithValidHits);
  muStandAloneTrackUpdatedAtVtxNRpcChambersWithValidHits.push_back(track.nRpcChambersWithValidHits);
  muStandAloneTrackUpdatedAtVtxInnermostStationWithValidHits.push_back(track.innermostStationWithValidHits);
  muStandAloneTrackUpdatedAtVtxOutermostStationWithValidHits.push_back(track.outermostStationWithValidHits);
  muStandAloneTrackUpdatedAtVtxQuality.push_back(track.quality);
  muStandAloneTrackUpdatedAtVtxInnerPx.push_back(track.innerPx);
  muStandAloneTrackUpdatedAtVtxInnerPy.push_back(track.innerPy);
  muStandAloneTrackUpdatedAtVtxInnerPz.push_back(track.innerPz);
  muStandAloneTrackUpdatedAtVtxInnerOk.push_back(track.innerOk);
  muStandAloneTrackUpdatedAtVtxInnerX.push_back(track.innerX);
  muStandAloneTrackUpdatedAtVtxInnerY.push_back(track.innerY);
  muStandAloneTrackUpdatedAtVtxInnerZ.push_back(track.innerZ);
  ...
  muStandAloneTrackUpdatedAtVtxCscSegChamber.push_back(track.cscSegChamber);
  muStandAloneTrackUpdatedAtVtxCscSegNHits.push_back(track.cscSegNHits);
  muStandAloneTrackUpdatedAtVtxCscSegPhi.push_back(track.cscSegPhi);
  muStandAloneTrackUpdatedAtVtxCscSegZ.push_back(track.cscSegZ);
  muStandAloneTrackUpdatedAtVtxCscSegR.push_back(track.cscSegR);
  muStandAloneTrackUpdatedAtVtxCscSegDirPhi.push_back(track.cscSegDirPhi);
  muStandAloneTrackUpdatedAtVtxCscSegDirTheta.push_back(track.cscSegDirTheta);
  muStandAloneTrackUpdatedAtVtxCscSegTime.push_back(track.cscSegTime);
  muStandAloneTrackUpdatedAtVtxRpcHitZ.push_back(track.rpcHitZ);
  muStandAloneTrackUpdatedAtVtxRpcHitRho.push_back(track.rpcHitRho);
  muStandAloneTrackUpdatedAtVtxRpcHitPhi.push_back(track.rpcHitPhi);
  muStandAloneTrackUpdatedAtVtxRpcHitRegion.push_back(track.rpcHitRegion);
  muStandAloneTrackUpdatedAtVtxRpcHitBx.push_back(track.rpcHitBx);
  muStandAloneTrackUpdatedAtVtxDtTofDirection.push_back(track.dtTofDirection);
  muStandAloneTrackUpdatedAtVtxDtTofNDof.push_back(track.dtTofNDof);
  muStandAloneTrackUpdatedAtVtxDtTofInverseBeta.push_back(track.dtTofInverseBeta);
  muStandAloneTrackUpdatedAtVtxDtTofInverseBetaErr.push_back(track.dtTofInverseBetaErr);
  muStandAloneTrackUpdatedAtVtxDtTofFreeInverseBeta.push_back(track.dtTofFreeInverseBeta);
  muStandAloneTrackUpdatedAtVtxDtTofFreeInverseBetaErr.push_back(track.dtTofFreeInverseBetaErr);
  muStandAloneTrackUpdatedAtVtxDtTofTimeAtIpInOut.push_back(track.dtTofTimeAtIpInOut);
  ...
  muStandAloneTrackUpdatedAtVtxShowerSize_station3.push_back(track.showerSize_station3);
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station0.push_back(track.showerDeltaR_station0);
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station1.push_back(track.showerDeltaR_station1);
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station2.push_back(track.showerDeltaR_station2);
  muStandAloneTrackUpdatedAtVtxShowerDeltaR_station3.push_back(track.showerDeltaR_station3);
  muStandAloneTrackUpdatedAtVtxShowerNHits_station0.push_back(track.showerNHits_station0);
  muStandAloneTrackUpdatedAtVtxShowerNHits_station1.push_back(track.showerNHits_station1);
  muStandAloneTrackUpdatedAtVtxShowerNHits_station2.push_back(track.showerNHits_station2);
  muStandAloneTrackUpdatedAtVtxShowerNHits_station3.push_back(track.showerNHits_station3);
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station0.push_back(track.showerNCorrelatedHits_station0);
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station1.push_back(track.showerNCorrelatedHits_station1);
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station2.push_back(track.showerNCorrelatedHits_station2);
  muStandAloneTrackUpdatedAtVtxShowerNCorrelatedHits_station3.push_back(track.showerNCorrelatedHits_station3);
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station0.push_back(track.showerNUncorrelatedHits_station0);
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station1.push_back(track.showerNUncorrelatedHits_station1);
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station2.push_back(track.showerNUncorrelatedHits_station2);
  muStandAloneTrackUpdatedAtVtxShowerNUncorrelatedHits_station3.push_back(track.showerNUncorrelatedHits_station3);
  ++mu_StandAloneUpdatedAtVtx_N;
}
