...
StoppedHSCPMuonEvent::StoppedHSCPMuonEvent() :
  ...
  mcDoublyChargedHiggs_N(0),
  mcDoublyChargedHiggsId(0),
  mcDoublyChargedHiggsMass(0),
  mcDoublyChargedHiggsCharge(0),
  mcDoublyChargedHiggsPx(0),
  mcDoublyChargedHiggsPy(0),
  mcDoublyChargedHiggsPz(0),
  mcDoublyChargedHiggsPt(0),
  mcDoublyChargedHiggsP(0),
  mcDoublyChargedHiggsE(0),
  mcDoublyChargedHiggsPhi(0),
  mcDoublyChargedHiggsEta(0),
  mcDoublyChargedHiggsStatus(0),
  mcDoublyChargedHiggsNMothers(0),
  mcDoublyChargedHiggsMotherId(0),
  mcDoublyChargedHiggsNDaughters(0),
  mcDoublyChargedHiggsDaughterId(0),
  mcDoublyChargedHiggsDaughterStatus(0),
  mcDoublyChargedHiggsGenIndex(0),
  mcChargino_N(0),
  mcCharginoId(0),
  mcCharginoMass(0),
  mcCharginoCharge(0),
  ...
  muCosmicTrackNStationsWithAnyHits(0),
  muCosmicTrackNCscChambersWithAnyHits(0),
  muCosmicTrackNDtChambersWithAnyHits(0),
  muCosmicTrackNRpcChambersWithAnyHits(0),
  muCosmicTrackInnermostStationWithAnyHits(0),
  muCosmicTrackOutermostStationWithAnyHits(0),
  muCosmicTrackNValidMuonHits(0),
  muCosmicTrackNValidCscHits(0),
  muCosmicTrackNValidDtHits(0),
  muCosmicTrackNValidRpcHits(0),
  muCosmicTrackNStationsWithValidHits(0),
  muCosmicTrackNCscChambersWithValidHits(0),
  muCosmicTrackNDtChambersWithValidHits(0),
  muCosmicTrackNRpcChambersWithValidHits(0),
  muCosmicTrackInnermostStationWithValidHits(0),
  muCosmicTrackOutermostStationWithValidHits(0),
  ...
  muCosmicTrackRpcHitRegion(0),
  muCosmicTrackRpcHitBx(0),
  mu_StandAlone_N(0),
  ...
  muStandAloneTrackNStationsWithAnyHits(0),
  muStandAloneTrackNCscChambersWithAnyHits(0),
  muStandAloneTrackNDtChambersWithAnyHits(0),
  muStandAloneTrackNRpcChambersWithAnyHits(0),
  muStandAloneTrackInnermostStationWithAnyHits(0),
  muStandAloneTrackOutermostStationWithAnyHits(0),
  muStandAloneTrackNValidMuonHits(0),
  muStandAloneTrackNValidCscHits(0),
  muStandAloneTrackNValidDtHits(0),
  muStandAloneTrackNValidRpcHits(0),
  muStandAloneTrackNStationsWithValidHits(0),
  muStandAloneTrackNCscChambersWithValidHits(0),
  muStandAloneTrackNDtChambersWithValidHits(0),
  muStandAloneTrackNRpcChambersWithValidHits(0),
  muStandAloneTrackInnermostStationWithValidHits(0),
  muStandAloneTrackOutermostStationWithValidHits(0),
  ...
  muRefittedStandAloneTrackNStationsWithAnyHits(0),
  muRefittedStandAloneTrackNCscChambersWithAnyHits(0),
  muRefittedStandAloneTrackNDtChambersWithAnyHits(0),
  muRefittedStandAloneTrackNRpcChambersWithAnyHits(0),
  muRefittedStandAloneTrackInnermostStationWithAnyHits(0),
  muRefittedStandAloneTrackOutermostStationWithAnyHits(0),
  muRefittedStandAloneTrackNValidMuonHits(0),
  muRefittedStandAloneTrackNValidCscHits(0),
  muRefittedStandAloneTrackNValidDtHits(0),
  muRefittedStandAloneTrackNValidRpcHits(0),
  muRefittedStandAloneTrackNStationsWithValidHits(0),
  muRefittedStandAloneTrackNCscChambersWithValidHits(0),
  muRefittedStandAloneTrackNDtChambersWithValidHits(0),
  muRefittedStandAloneTrackNRpcChambersWithValidHits(0),
  muRefittedStandAloneTrackInnermostStationWithValidHits(0),
  muRefittedStandAloneTrackOutermostStationWithValidHits(0),
  ...
  mu_DisplacedStandAlone_N(0),
  muDisplacedStandAloneCharge(0),
  muDisplacedStandAlonePx(0),
  muDisplacedStandAlonePy(0),
  muDisplacedStandAlonePz(0),
  muDisplacedStandAlonePt(0),
  muDisplacedStandAloneP(0),
  muDisplacedStandAloneEta(0),
  muDisplacedStandAlonePhi(0),
  muDisplacedStandAloneHcalEta(0),
  muDisplacedStandAloneHcalPhi(0),
  muDisplacedStandAloneTrackChi2(0),
  muDisplacedStandAloneTrackNdof(0),
  muDisplacedStandAloneTrackNormalizedChi2(0),
  muDisplacedStandAloneTrackVx(0),
  muDisplacedStandAloneTrackVy(0),
  muDisplacedStandAloneTrackVz(0),
  muDisplacedStandAloneTrackDxy(0),
  muDisplacedStandAloneTrackDz(0),
  muDisplacedStandAloneTrackNHits(0),
  muDisplacedStandAloneTrackNLost(0),
  muDisplacedStandAloneTrackNStationsWithAnyHits(0),
  muDisplacedStandAloneTrackNCscChambersWithAnyHits(0),
  muDisplacedStandAloneTrackNDtChambersWithAnyHits(0),
  muDisplacedStandAloneTrackNRpcChambersWithAnyHits(0),
  muDisplacedStandAloneTrackInnermostStationWithAnyHits(0),
  muDisplacedStandAloneTrackOutermostStationWithAnyHits(0),
  muDisplacedStandAloneTrackNValidMuonHits(0),
  muDisplacedStandAloneTrackNValidCscHits(0),
  muDisplacedStandAloneTrackNValidDtHits(0),
  muDisplacedStandAloneTrackNValidRpcHits(0),
  muDisplacedStandAloneTrackNStationsWithValidHits(0),
  muDisplacedStandAloneTrackNCscChambersWithValidHits(0),
  muDisplacedStandAloneTrackNDtChambersWithValidHits(0),
  muDisplacedStandAloneTrackNRpcChambersWithValidHits(0),
  muDisplacedStandAloneTrackInnermostStationWithValidHits(0),
  muDisplacedStandAloneTrackOutermostStationWithValidHits(0),
  muDisplacedStandAloneTrackQuality(0),
  muDisplacedStandAloneTrackInnerPx(0),
  muDisplacedStandAloneTrackInnerPy(0),
  muDisplacedStandAloneTrackInnerPz(0),
  muDisplacedStandAloneTrackInnerOk(0),
  muDisplacedStandAloneTrackInnerX(0),
  muDisplacedStandAloneTrackInnerY(0),
  muDisplacedStandAloneTrackInnerZ(0),
  ...
  muDisplacedStandAloneTrackDtTofInverseBetaErr(0),
  muDisplacedStandAloneTrackDtTofFreeInverseBeta(0),
  muDisplacedStandAloneTrackDtTofFreeInverseBetaErr(0),
  muDisplacedStandAloneTrackDtTofTimeAtIpInOut(0),
  ...
  muDisplacedStandAloneTrackShowerSize_station3(0), 
  muDisplacedStandAloneTrackShowerDeltaR_station0(0), 
  muDisplacedStandAloneTrackShowerDeltaR_station1(0), 
  muDisplacedStandAloneTrackShowerDeltaR_station2(0), 
  muDisplacedStandAloneTrackShowerDeltaR_station3(0), 
  muDisplacedStandAloneTrackShowerNHits_station0(0), 
  muDisplacedStandAloneTrackShowerNHits_station1(0), 
  muDisplacedStandAloneTrackShowerNHits_station2(0), 
  muDisplacedStandAloneTrackShowerNHits_station3(0), 
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station0(0), 
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station1(0), 
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station2(0), 
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station3(0), 
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station0(0), 
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station1(0), 
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station2(0), 
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station3(0), 
  muDisplacedStandAloneTrackRpcHitZ(0),
  muDisplacedStandAloneTrackRpcHitRho(0),
  muDisplacedStandAloneTrackRpcHitPhi(0),
  muDisplacedStandAloneTrackRpcHitRegion(0),
  muDisplacedStandAloneTrackRpcHitBx(0),
  nVtx(0),
  vtx_N(0),
  vtxNDOF(0),
  vtxZ(0),
...
void StoppedHSCPMuonEvent::addCosmicMuonTrack(Track track) {
  ...
  muCosmicTrackNStationsWithAnyHits.push_back(track.nStationsWithAnyHits);
  muCosmicTrackNCscChambersWithAnyHits.push_back(track.nCscChambersWithAnyHits);
  muCosmicTrackNDtChambersWithAnyHits.push_back(track.nDtChambersWithAnyHits);
  muCosmicTrackNRpcChambersWithAnyHits.push_back(track.nRpcChambersWithAnyHits);
  muCosmicTrackInnermostStationWithAnyHits.push_back(track.innermostStationWithAnyHits);
  muCosmicTrackOutermostStationWithAnyHits.push_back(track.outermostStationWithAnyHits);
  muCosmicTrackNValidMuonHits.push_back(track.nValidMuonHits);
  muCosmicTrackNValidCscHits.push_back(track.nValidCscHits);
  muCosmicTrackNValidDtHits.push_back(track.nValidDtHits);
  muCosmicTrackNValidRpcHits.push_back(track.nValidRpcHits);
  muCosmicTrackNStationsWithValidHits.push_back(track.nStationsWithValidHits);
  muCosmicTrackNCscChambersWithValidHits.push_back(track.nCscChambersWithValidHits);
  muCosmicTrackNDtChambersWithValidHits.push_back(track.nDtChambersWithValidHits);
  muCosmicTrackNRpcChambersWithValidHits.push_back(track.nRpcChambersWithValidHits);
  muCosmicTrackInnermostStationWithValidHits.push_back(track.innermostStationWithValidHits);
  muCosmicTrackOutermostStationWithValidHits.push_back(track.outermostStationWithValidHits);
  ...
  muCosmicTrackRpcHitRegion.push_back(track.rpcHitRegion);
  muCosmicTrackRpcHitBx.push_back(track.rpcHitBx);
  ++mu_CosmicTrack_N;
}
...
void StoppedHSCPMuonEvent::addStandAloneMuon(Track track) { 
  ...
  muStandAloneTrackNStationsWithAnyHits.push_back(track.nStationsWithAnyHits);
  muStandAloneTrackNCscChambersWithAnyHits.push_back(track.nCscChambersWithAnyHits);
  muStandAloneTrackNDtChambersWithAnyHits.push_back(track.nDtChambersWithAnyHits);
  muStandAloneTrackNRpcChambersWithAnyHits.push_back(track.nRpcChambersWithAnyHits);
  muStandAloneTrackInnermostStationWithAnyHits.push_back(track.innermostStationWithAnyHits);
  muStandAloneTrackOutermostStationWithAnyHits.push_back(track.outermostStationWithAnyHits);
  muStandAloneTrackNValidMuonHits.push_back(track.nValidMuonHits);
  muStandAloneTrackNValidCscHits.push_back(track.nValidCscHits);
  muStandAloneTrackNValidDtHits.push_back(track.nValidDtHits);
  muStandAloneTrackNValidRpcHits.push_back(track.nValidRpcHits);
  muStandAloneTrackNStationsWithValidHits.push_back(track.nStationsWithValidHits);
  muStandAloneTrackNCscChambersWithValidHits.push_back(track.nCscChambersWithValidHits);
  muStandAloneTrackNDtChambersWithValidHits.push_back(track.nDtChambersWithValidHits);
  muStandAloneTrackNRpcChambersWithValidHits.push_back(track.nRpcChambersWithValidHits);
  muStandAloneTrackInnermostStationWithValidHits.push_back(track.innermostStationWithValidHits);
  muStandAloneTrackOutermostStationWithValidHits.push_back(track.outermostStationWithValidHits);
...
void StoppedHSCPMuonEvent::addRefittedStandAloneMuon(Track track) {
  ...
  muRefittedStandAloneTrackNStationsWithAnyHits.push_back(track.nStationsWithAnyHits);
  muRefittedStandAloneTrackNCscChambersWithAnyHits.push_back(track.nCscChambersWithAnyHits);
  muRefittedStandAloneTrackNDtChambersWithAnyHits.push_back(track.nDtChambersWithAnyHits);
  muRefittedStandAloneTrackNRpcChambersWithAnyHits.push_back(track.nRpcChambersWithAnyHits);
  muRefittedStandAloneTrackInnermostStationWithAnyHits.push_back(track.innermostStationWithAnyHits);
  muRefittedStandAloneTrackOutermostStationWithAnyHits.push_back(track.outermostStationWithAnyHits);
  muRefittedStandAloneTrackNValidMuonHits.push_back(track.nValidMuonHits);
  muRefittedStandAloneTrackNValidCscHits.push_back(track.nValidCscHits);
  muRefittedStandAloneTrackNValidDtHits.push_back(track.nValidDtHits);
  muRefittedStandAloneTrackNValidRpcHits.push_back(track.nValidRpcHits);
  muRefittedStandAloneTrackNStationsWithValidHits.push_back(track.nStationsWithValidHits);
  muRefittedStandAloneTrackNCscChambersWithValidHits.push_back(track.nCscChambersWithValidHits);
  muRefittedStandAloneTrackNDtChambersWithValidHits.push_back(track.nDtChambersWithValidHits);
  muRefittedStandAloneTrackNRpcChambersWithValidHits.push_back(track.nRpcChambersWithValidHits);
  muRefittedStandAloneTrackInnermostStationWithValidHits.push_back(track.innermostStationWithValidHits);
  muRefittedStandAloneTrackOutermostStationWithValidHits.push_back(track.outermostStationWithValidHits);
...
void StoppedHSCPMuonEvent::addDisplacedStandAloneMuon(Track track) {
  muDisplacedStandAloneCharge.push_back(track.charge);
  muDisplacedStandAlonePx.push_back(track.px);
  muDisplacedStandAlonePy.push_back(track.py);
  muDisplacedStandAlonePz.push_back(track.pz);
  muDisplacedStandAlonePt.push_back(track.pt);
  muDisplacedStandAloneP.push_back(track.p);
  muDisplacedStandAloneEta.push_back(track.eta);
  muDisplacedStandAlonePhi.push_back(track.phi);
  muDisplacedStandAloneHcalEta.push_back(track.hcalEta);
  muDisplacedStandAloneHcalPhi.push_back(track.hcalPhi);
  muDisplacedStandAloneTrackChi2.push_back(track.chi2);
  muDisplacedStandAloneTrackNdof.push_back(track.ndof);
  muDisplacedStandAloneTrackNormalizedChi2.push_back(track.normalizedChi2);
  muDisplacedStandAloneTrackVx.push_back(track.vx);
  muDisplacedStandAloneTrackVy.push_back(track.vy);
  muDisplacedStandAloneTrackVz.push_back(track.vz);
  muDisplacedStandAloneTrackDxy.push_back(track.dxy);
  muDisplacedStandAloneTrackDz.push_back(track.dz);
  muDisplacedStandAloneTrackNHits.push_back(track.nHits);
  muDisplacedStandAloneTrackNLost.push_back(track.nLost);
  muDisplacedStandAloneTrackNStationsWithAnyHits.push_back(track.nStationsWithAnyHits);
  muDisplacedStandAloneTrackNCscChambersWithAnyHits.push_back(track.nCscChambersWithAnyHits);
  muDisplacedStandAloneTrackNDtChambersWithAnyHits.push_back(track.nDtChambersWithAnyHits);
  muDisplacedStandAloneTrackNRpcChambersWithAnyHits.push_back(track.nRpcChambersWithAnyHits);
  muDisplacedStandAloneTrackInnermostStationWithAnyHits.push_back(track.innermostStationWithAnyHits);
  muDisplacedStandAloneTrackOutermostStationWithAnyHits.push_back(track.outermostStationWithAnyHits);
  muDisplacedStandAloneTrackNValidMuonHits.push_back(track.nValidMuonHits);
  muDisplacedStandAloneTrackNValidCscHits.push_back(track.nValidCscHits);
  muDisplacedStandAloneTrackNValidDtHits.push_back(track.nValidDtHits);
  muDisplacedStandAloneTrackNValidRpcHits.push_back(track.nValidRpcHits);
  muDisplacedStandAloneTrackNStationsWithValidHits.push_back(track.nStationsWithValidHits);
  muDisplacedStandAloneTrackNCscChambersWithValidHits.push_back(track.nCscChambersWithValidHits);
  muDisplacedStandAloneTrackNDtChambersWithValidHits.push_back(track.nDtChambersWithValidHits);
  muDisplacedStandAloneTrackNRpcChambersWithValidHits.push_back(track.nRpcChambersWithValidHits);
  muDisplacedStandAloneTrackInnermostStationWithValidHits.push_back(track.innermostStationWithValidHits);
  muDisplacedStandAloneTrackOutermostStationWithValidHits.push_back(track.outermostStationWithValidHits);
  muDisplacedStandAloneTrackQuality.push_back(track.quality);
  muDisplacedStandAloneTrackInnerPx.push_back(track.innerPx);
  muDisplacedStandAloneTrackInnerPy.push_back(track.innerPy);
  muDisplacedStandAloneTrackInnerPz.push_back(track.innerPz);
  muDisplacedStandAloneTrackInnerOk.push_back(track.innerOk);
  muDisplacedStandAloneTrackInnerX.push_back(track.innerX);
  muDisplacedStandAloneTrackInnerY.push_back(track.innerY);
  muDisplacedStandAloneTrackInnerZ.push_back(track.innerZ);
  ...
  muDisplacedStandAloneTrackRpcHitRegion.push_back(track.rpcHitRegion);
  muDisplacedStandAloneTrackRpcHitBx.push_back(track.rpcHitBx);
  muDisplacedStandAloneTrackDtTofDirection.push_back(track.dtTofDirection);
  muDisplacedStandAloneTrackDtTofNDof.push_back(track.dtTofNDof);
  muDisplacedStandAloneTrackDtTofInverseBeta.push_back(track.dtTofInverseBeta);
  muDisplacedStandAloneTrackDtTofInverseBetaErr.push_back(track.dtTofInverseBetaErr);
  muDisplacedStandAloneTrackDtTofFreeInverseBeta.push_back(track.dtTofFreeInverseBeta);
  muDisplacedStandAloneTrackDtTofFreeInverseBetaErr.push_back(track.dtTofFreeInverseBetaErr);
  muDisplacedStandAloneTrackDtTofTimeAtIpInOut.push_back(track.dtTofTimeAtIpInOut);
  ...
  muDisplacedStandAloneTrackShowerSize_station3.push_back(track.showerSize_station3);
  muDisplacedStandAloneTrackShowerDeltaR_station0.push_back(track.showerDeltaR_station0);
  muDisplacedStandAloneTrackShowerDeltaR_station1.push_back(track.showerDeltaR_station1);
  muDisplacedStandAloneTrackShowerDeltaR_station2.push_back(track.showerDeltaR_station2);
  muDisplacedStandAloneTrackShowerDeltaR_station3.push_back(track.showerDeltaR_station3);
  muDisplacedStandAloneTrackShowerNHits_station0.push_back(track.showerNHits_station0);
  muDisplacedStandAloneTrackShowerNHits_station1.push_back(track.showerNHits_station1);
  muDisplacedStandAloneTrackShowerNHits_station2.push_back(track.showerNHits_station2);
  muDisplacedStandAloneTrackShowerNHits_station3.push_back(track.showerNHits_station3);
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station0.push_back(track.showerNCorrelatedHits_station0);
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station1.push_back(track.showerNCorrelatedHits_station1);
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station2.push_back(track.showerNCorrelatedHits_station2);
  muDisplacedStandAloneTrackShowerNCorrelatedHits_station3.push_back(track.showerNCorrelatedHits_station3);
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station0.push_back(track.showerNUncorrelatedHits_station0);
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station1.push_back(track.showerNUncorrelatedHits_station1);
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station2.push_back(track.showerNUncorrelatedHits_station2);
  muDisplacedStandAloneTrackShowerNUncorrelatedHits_station3.push_back(track.showerNUncorrelatedHits_station3);
  ++mu_DisplacedStandAlone_N;
}
