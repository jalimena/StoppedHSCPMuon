...
# with command line options: Configuration/GenProduction/python/EightTeV/HSCPgluino_M_1300_Tune4C_8TeV_pythia8_cff.py --fileout file:step1_gluino1300.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions START71_V8A::All --beamspot Realistic8TeVCollision --step GEN,SIM --python_filename step1_gluino1300_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi.customise -n 50
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/HSCPgluino_M_1300_Tune4C_8TeV_pythia8_cff.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_gluino1300.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    SLHAFileForPythia8 = cms.string('Configuration/Generator/data/HSCP_gluino_1300_SLHA.spc'),
    ...
    massPoint = cms.untracked.int32(1300),
    particleFile = cms.untracked.string('Configuration/Generator/data/particles_gluino_1300_GeV.txt'),
    slhaFile = cms.untracked.string('Configuration/Generator/data/HSCP_gluino_1300_SLHA.spc'),
    processFile = cms.untracked.string('SimG4Core/CustomPhysics/data/RhadronProcessList.txt'),
    pdtFile = cms.FileInPath('Configuration/Generator/data/hscppythiapdtgluino1300.tbl'),
