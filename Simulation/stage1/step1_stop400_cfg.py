...
# with command line options: Configuration/GenProduction/python/EightTeV/HSCPstop_M_400_Tune4C_8TeV_pythia8_cff.py --fileout file:step1_stop400.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions START71_V8A::All --beamspot Realistic8TeVCollision --step GEN,SIM --python_filename step1_stop400_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi.customise -n 50
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/HSCPstop_M_400_Tune4C_8TeV_pythia8_cff.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_stop400.root'),
