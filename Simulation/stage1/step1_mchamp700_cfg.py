...
# with command line options: Configuration/GenProduction/python/EightTeV/HSCPmchamp6_M_700_TuneZ2star_8TeV_pythia6_cff.py --fileout file:step1_mchamp700.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions START71_V8A::All --beamspot Realistic8TeVCollision --step GEN,SIM --python_filename step1_mchamp700_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi.customise -n 50
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/HSCPmchamp6_M_700_TuneZ2star_8TeV_pythia6_cff.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_mchamp700.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0 ! User defined processes', 
            ...
            'CKIN(1)=700.000000 !min sqrt(s hat)', 
            'CKIN(2)= -1 ! (no) max sqrt(s hat) (GeV)', 
            'KCHG(17,1)=6 !charge of tauprime', 
            'PMAS(17,1)=700.000000 !tauprime mass', 
    ...
    particleFile = cms.untracked.string('Configuration/Generator/data/particles_HIP6_stau_700_GeV.txt'),
    pdtFile = cms.FileInPath('Configuration/Generator/data/hscppythiapdtHIP6stau700.tbl')
)
