...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/HSCPstop_M_900_Tune4C_8TeV_pythia8_cff.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_stop900.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    SLHAFileForPythia8 = cms.string('Configuration/Generator/data/HSCP_stop_900_SLHA.spc'),
    ...
    slhaFile = cms.untracked.string('Configuration/Generator/data/HSCP_stop_900_SLHA.spc'),
